...
function List(props: ListProps) {
  return (
    <div className='w-full overflow-y-auto lg:px-8 lg:pb-8 pt-0'>
      <div className='flex w-full flex-1 flex-col flex-wrap items-center gap-6 md:gap-8 md:flex-row md:justify-between lg:justify-around lg:items-start'>
